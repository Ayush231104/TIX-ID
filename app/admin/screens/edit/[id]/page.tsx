...
import { getAdminScreenById } from '@/actions/adminActions'

type Params = {
  params: Promise<{ id: string }>
}

export default async function AdminEditScreenPage({ params }: Params) {
  ...
  return (
    <section className="max-w-4xl">
      ...
      <Link href="/admin/screens" className="mt-4 inline-block text-royal-blue-default hover:underline">
