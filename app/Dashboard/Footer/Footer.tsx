      ...
      <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 md:gap-6 px-16 mb-18 mx-auto'>
        ...
        <div className='lg:col-span-3 grid grid-cols-1 md:grid-cols-3 gap-4 lg:gap-8 '>
          <div className='flex flex-col gap-2 lg:gap-4'>
            <Typography variant='h4' color='shade-900'>Company</Typography>
          ...
          <div className='flex flex-col gap-2 lg:gap-4'>
            <Typography variant='h4' className='text-lg font-medium text-shade-900'>About</Typography>
          ...
          <div className='flex flex-col gap-2 lg:gap-4'>
            <Typography variant='h4' className='text-lg font-medium text-shade-900'>Support</Typography>
        ...
        <div className='lg:col-span-2 lg:pl-20'>
          <div>
            <Typography variant='h4' color='shade-900' className='mb-6'>Follow Social Media</Typography>
            <div className='flex gap-6 mb-10.5'>
              <FaInstagram size={24} />
              <FaTwitter size={24} />
              <FaFacebook size={24} />
            </div>
